  ...
  return (
      <div className='grid'>
        <div className='grid gap-2 mb-5 md:mb-10'>
            ...
            <p className="text-xl md:text-2xl 2xl:text-3xl">And finally grown up <FontAwesomeIcon icon={faSeedling} /> to be a Tech Lead DevOps <FontAwesomeIcon icon={faCloud} /></p>
        </div>
